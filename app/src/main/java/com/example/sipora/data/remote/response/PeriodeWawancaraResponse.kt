...
data class PeriodeWawancaraResponse(
    ...
    @SerializedName("jadwalWawancaraFileName") val jadwalWawancaraFileName: String?,
    @SerializedName("jadwalWawancaraPath") val jadwalWawancaraPath: String?,
