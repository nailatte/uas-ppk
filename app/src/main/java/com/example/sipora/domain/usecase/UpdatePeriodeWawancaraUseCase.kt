...
class UpdatePeriodeWawancaraUseCase @Inject constructor(
    ...
    operator fun invoke(
        ...
        return repository.updatePeriode(id, namaKegiatan, deskripsi, tanggalMulaiIso, tanggalSelesaiIso, filePart)
    }
}
